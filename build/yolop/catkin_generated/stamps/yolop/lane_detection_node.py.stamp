...
def make_parser():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=f'{path}/src/yolop/data/weights/yolopv2.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default=f'{path}/src/yolop/input/drive.mp4', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--project', default=f'{path}/src/yolop/runs/detect', help='save results to project/name')
